...
class QueueTest3 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:queueTest3 {date? : 要查詢的日期(例: 2019-11-13)}';
    ...
    public function handle()
    {
        ...
        if (!$this->date) {
            ...
            $this->date = date_format($this->date,"Y-m-d H:i");
        }
        ...
        $this->date = date("Y-m-d H:i", strtotime("{$this->date} +1 minutes"));
        
        $this->call('command:queueTest3');
    }
}
